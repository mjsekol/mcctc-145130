"""A stand-in for the model service your class built in Module 5.
...
# The five labels the front office actually sorts by. Same list Module 5 used,
# because the automation is running against the application you already built.
