...
CREATE TABLE appearances (
    ...
    -- Step 4 fix: the list of roles lived only in the kiosk, so any other
    -- program could write any word into this column. Now the database owns it.
    role     TEXT NOT NULL CHECK (role IN ('striker', 'midfield', 'keeper',
